...
import TransfertEmisSuccessMessage from "./transfertEmisSucessMessagePopup";

function ConfirmationNouveauTransfert({ isModalVisible, setModalVisible }) {
    const toggleModal = () => {
    ...
    const [showTransfertSucessPopup, setShowTransfertSucessPopup] = useState(false)
    ...
    return (
        <>
            {!showTransfertSucessPopup && <StyledView className="flex flex-col item-center justify-center w-full h-full">
                        ...
                        <StyledView className={`flex flex-col w-[95%] ${styleSheet.popupContainerWidth} h-[90%] bg-[#fff] rounded-lg p-2`}>
                            <StyledView className='flex flex-col w-full space-y-[20px] justify-center items-center '>
                                ...
                                <StyledView className="flex flex-row w-full justify-center items-center space-x-2 ">
                                    ...
                                    <Pressable className="flex flex-row w-[100px] h-[30px] items-center justify-center bg-[#38b849] rounded-lg" onPress={() => {
                                        setShowTransfertSucessPopup(true)
                                    }}>
                                        <Text className="font-bold text-lg ">
                                            Valider
                                        </Text>
            ...
            {showTransfertSucessPopup && <TransfertEmisSuccessMessage isModalVisible={showTransfertSucessPopup} setModalVisible={setShowTransfertSucessPopup} />}
        </>
    );
}
...
export default React.memo(ConfirmationNouveauTransfert)