...
function MoreDetailsTransfertEmis({ isModalVisible, setModalVisible }) {
    const toggleModal = () => {
                    ...
                    <StyledView className={`flex flex-col w-[95%] ${styleSheet.popupContainerWidth} h-[90%] bg-[#fff] rounded-lg p-2`}>
                        <StyledView className='flex flex-col w-full space-y-[20px] justify-center items-center '>
                            ...
                            <StyledView className="flex flex-row w-full justify-center items-center space-x-2 ">
                                <Pressable className="flex flex-row w-[70px] h-[30px] items-center justify-center bg-[#df9b43] rounded-lg" onPress={() => setModalVisible(false)}>
                                    <Text className="font-bold  ">
                                        Retour
                                    </Text>
                                </Pressable>
                                <Pressable className="flex flex-row w-[70px] h-[30px] items-center justify-center bg-[#3bcc5f] rounded-lg" onPress={() => setModalVisible(false)}>
                                    <Text className="font-bold ">
                                        Modifier
                                    </Text>
                                </Pressable>
                                <Pressable className="flex flex-row w-[70px] h-[30px] items-center justify-center bg-[#d84f45] rounded-lg" onPress={() => setModalVisible(false)}>
                                    <Text className="font-bold  ">
                                        Annuler
                                    </Text>
                                </Pressable>
                                <Pressable className="flex flex-row w-[70px] h-[30px] items-center justify-center bg-[#d84cdd] rounded-lg" onPress={() => setModalVisible(false)}>
                                    <Text className="font-bold ">
                                        Bloquer
                                    </Text>
                                </Pressable>
...
export default React.memo(MoreDetailsTransfertEmis)