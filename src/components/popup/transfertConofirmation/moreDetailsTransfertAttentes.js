...
import TransfertValiderSuccessMessage from '../transfertConofirmation/transfertValiderSuccessPopup'

function MoreDetailsTransfertAttentes({ isModalVisible, setModalVisible }) {
    const toggleModal = () => {
    ...
    const [showTransferValidertSucessPopup, setShowTransfertValiderSucessPopup] = useState(false)
    ...
    return (
        <>
            {!showTransferValidertSucessPopup && <StyledView className="flex flex-col item-center justify-center w-full h-full">
                            ...
                            <StyledView className='flex flex-col w-full space-y-[20px] justify-center items-center '>
                                <Pressable onPress={(event) => {
                                    ...
                                    <StyledView className='flex flex-col items-center w-[200px] h-[60px]'>
                                        <Text className="uppercase text-md font-bold w-full text-center text-[#115DA9]">Details du transfert 204KF</Text>
                                ...
                                <StyledView className="flex flex-row w-full justify-center items-center space-x-2 ">
                                    ...
                                    <Pressable className="flex flex-row w-[100px] h-[30px] items-center justify-center bg-[#5bad2b] rounded-lg" onPress={() => {
                                        setModalVisible(false)
                                        setShowTransfertValiderSucessPopup(true)
                                    }}>
                                        <Text className="font-bold text-lg ">
                                            Valider
                                        </Text>
            ...
            {showTransferValidertSucessPopup && <TransfertValiderSuccessMessage isModalVisible={showTransferValidertSucessPopup} setModalVisible={setShowTransfertValiderSucessPopup} />}
        </>
    );
}
...
export default React.memo(MoreDetailsTransfertAttentes)