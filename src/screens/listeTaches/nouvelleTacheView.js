...
function ListeTache() {
    ...
    return (
        <StyledView className="flex-1">
            <Text className={`w-full font-bold text-[20px] italic text-[#2358ad] text-center my-2`}>Nouvelle Tâche</Text>
            <ScrollView
                ...
                <StyledView className="flex-1 flex-col justify-center items-center mt-2 space-y-[40px]">
                    <StyledView className="flex">
                        <StyledView className="flex  flex-col w-[300px] h-[80px] self-center">
                            <Text className="flex w-[150px] h-[30px] bg-[#4db42d] rounded-t-[10px] text-[#fff] text-center font-bold">Titre De la Tâche</Text>
                            <TextInput
                    ...
                    <StyledView className="flex flex-col w-[300px] h-[80px] self-center">
                        <Text className="flex w-[130px] h-[30px] bg-[#4db42d] rounded-t-[10px] text-[#fff] text-center font-bold">Lieux D'execution</Text>
                        <TextInput
                            className="flex-1 items-center border-[3px] rounded-r-md rounded-b-md p-4"
                            placeholder="ex : je dois aller "
                            multiline={true}
                        />
                    </StyledView>
...
export default React.memo(ListeTache)
