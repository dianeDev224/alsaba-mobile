...
export default function NouvelleInjection({ navigateTo }) {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#f3f1c8" }} className="flex mt-5">
                    <StyledView className="flex h-[100%] space-y-6">
                        <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Nouvelle Injection</Text>
            ...
            appendStyle={{ parent: { alignSelf: 'flex-start', width: '20%' }, child: { borderTopColor: '#bbb76d' } }}
        />
    )
}
