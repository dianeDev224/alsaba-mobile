...
const tableHead = ['Date', 'Bénéfice', 'Capital Propre', 'Action'];
const tableData = [
    ['1', '2', 'sortie', '4'],
    ['a', 'b', 'entré', 'd'],
    ['1', '2', 'sortie', '456\n789'],
...
export default function Resultats({ navigateTo }) {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <StyledView className="flex  flex-col item-center justify-center flex-1 p-2 space-y-7">
                ...
                <Table style={styles.head} borderStyle={{ borderWidth: 3, borderColor: '#fff' }}>
                    <TableWrapper className="flex flex-row bg-[#2c558a] h-[40px] rounded-lg flex-1">
                        {
                ...
                <StyledView className='flex flex-row w-full justify-center items-center h-[40px]'>
                    ...
                    <Text className={`font-bold text-[20px] bg-[#2c558a] text-[#fff]`}>{currentPage}</Text>
