...
export default function NouvelleChargeFictive() {
    ...
    return (
        ...
        <WithNavbarSwippe
            ScreenSwippe={<StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#f5f3d9" }} className="flex  mt-5">
                <StyledView className="flex h-[100%] space-y-6">
                    <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Nouvelle Charge Fictive</Text>
            ...
            appendStyle={{ parent: { left: '0%', width: '40%' }, child: { borderTopColor: '#b5ae24' } }}
        />
    )
}
