...
export default function NouvelleAutoInjection() {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#f1f0d5" }} className="flex  mt-5">
                    <StyledView className="flex space-y-6">
                        <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Nouvelle Auto Injection</Text>
