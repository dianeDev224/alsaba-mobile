...
export default function AutoInjectionEffectuer() {
    ...
    return (
        ...
        <WithNavbarSwippe
            ScreenSwippe={<StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#d0e4d0" }} className="flex  mt-5">
