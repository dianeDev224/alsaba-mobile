...
export default function AutoInjectionAnnuler() {
    ...
    return (
        ...
        <WithNavbarSwippe
            ScreenSwippe={<StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#e0c3ca" }} className="flex  mt-5">
                <StyledView className="flex  flex-col item-center justify-center h-[100%] p-2 space-y-7">
                    <StyledView className='flex flex-row items-center justify-center'>
                        <Text className="font-bold text-[#626663]">
                            Auto Injection Annulées
                        </Text>
                    </StyledView>

                    <ScrollView>
                        <Table style={styles.head} borderStyle={{ borderWidth: 3, borderColor: '#fff' }}>
                            <TableWrapper className="flex flex-row bg-[#c07889] h-[40px] rounded-lg flex-1">
                                {
            ...
            appendStyle={{ parent: { left: '70%', width: '30%' }, child: { borderTopColor: '#c07889' } }}
        />
    )
