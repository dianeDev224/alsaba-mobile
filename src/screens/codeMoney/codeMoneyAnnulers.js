...
export default function CodeMoneyAnnulers() {
    ...
    return (
        <StyledView className='flex-1 bg-[#f1dfe1]'>
            <StyledView className="flex flex-col item-center justify-center w-full">
                <Text className={`w-full font-bold text-[15px] italic text-[#94161f] text-center my-2`}>Code Money Annulés</Text>
                ...
                <StyledView>
                    ...
                    <StyledView className='flex flex-row w-full justify-center items-center h-[40px]'>
                        ...
                        <Text className={`font-bold text-[20px] bg-[#94161f] text-[#fff]`}>{currentPage}</Text>
    ...
    return (
        <Modal isVisible={show} className={`flex flex-col b-[#ffa] self-center flex-1`}>
            <OutsidePressHandler className="bg-[#fff] flex flex-col basis-[250px] w-[300px] space-y-5 p-4" onOutsidePress={() => toggleShow(false)}>
                <StyledView className="flex flex-row items-center justify-center w-[200px] h-[40px] bg-[#94161f] self-center">
                    <Text className="text-[#fff] font-bold">Details Du CodeMoney #ff4</Text>
                </StyledView>
                ...
                <StyledView className="flex flex-row justify-around">
                    <Pressable className="  bg-[#cc813b]  w-[100px] h-[30px] items-center justify-center" onPress={() => toggleShow(false)}>
                    ...
                    <Pressable className="bg-[#b63232] w-[100px] h-[30px] items-center justify-center" onPress={() => toggleShow(false)}>
                        <Text className="text-[#fff] font-bold">Annuler</Text>
                    </Pressable>
                </StyledView>
            </OutsidePressHandler>
        </Modal>
...
const styles = StyleSheet.create({
    ...
    head: {
        height: 40, backgroundColor: "#94161f", textAlign: 'center', fontWeight: 'bold'
    },
    headText: {
        textAlign: 'center',
        color: "#fff",
