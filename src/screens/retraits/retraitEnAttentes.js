...
export default function RetraitEnattentes({ itemName = "Transfert Annulés" }) {
    ...
    return (
        <StyledView className='flex-1 bg-[#e9dfee]'>
            <StyledView className="flex flex-col item-center justify-center w-full">
                <Text className={`w-full font-bold text-[15px] italic text-[#6e1694] text-center my-2`}>Retrait En Attentes</Text>
                ...
                <ScrollView>
                    ...
                    <StyledView className='flex flex-row w-full justify-center items-center h-[40px]'>
                        ...
                        <Text className={`font-bold text-[20px] bg-[#6e1694] text-[#fff]`}>{currentPage}</Text>
    ...
    return (
        <Modal isVisible={show} className={`flex flex-col b-[#ffa] self-center flex-1`}>
            <OutsidePressHandler className="bg-[#fff] flex flex-col basis-[250px] w-[300px] space-y-5 p-4" onOutsidePress={() => toggleShow(false)}>
                <StyledView className="flex flex-row items-center justify-center w-[200px] h-[40px] bg-[#6e1694] self-center">
                    <Text className="text-[#fff] font-bold">Details Du Retrait #ff4</Text>
                </StyledView>
                ...
                <StyledView className="flex flex-row justify-around">
                    ...
                    <Pressable className="flex flex-row h-[30px] w-[100px] bg-[#4db42d] self-center items-center justify-center " onPress={() => setShowConfirm(true)}>
...
const styles = StyleSheet.create({
    ...
    head: {
        height: 40, backgroundColor: "#6e1694", textAlign: 'center', fontWeight: 'bold'
    },
    headText: {
        textAlign: 'center',
        color: "#fff",
