...
export default function RetraitEffectuer({ itemName = "Transfert Annulés" }) {
    ...
    return (
        <StyledView className='flex-1 bg-[#f1f1db]'>
            <StyledView className="flex flex-col item-center justify-center w-full">
                <Text className={`w-full font-bold text-[15px] italic text-[#706f1e] text-center my-2`}>Retraits Effectués</Text>
