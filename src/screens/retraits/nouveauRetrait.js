...
function NouveauRetrait() {
    ...
    return (
        <StyledView className="flex-1 bg-[#dfe4eb]">
            <Text className={`w-full font-bold text-[20px] italic text-[#2358ad] text-center my-2`}>Nouveau Retrait</Text>
            <ScrollView
            ...
            >
                <StyledView className="flex-1 flex-col items-center justify-center space-y-[50px]">
                    <StyledView className="flex  flex-col w-[300px] h-[100px] self-center">
                        <Text className="flex w-[150px] h-[30px] bg-[#2358ad] rounded-t-[10px] text-[#fff] text-center font-bold">Tel Debiteur</Text>
                        <TextInput
                    ...
                    <StyledView className="flex flex-col  space-y-3 items-center justify-between my-2">
                        <DropDown item={caveaux} popupContainerWidth={"w-[40px]"} color={"#2358ad"} defaultButtonText="Caveaux Source" width={230} key={"&ss"} />
                    </StyledView>
        ...
        <Modal isVisible={show} ref={ref} className={`flex flex-col b-[#ffa] self-center flex-1`}>
            <OutsidePressHandler className="bg-[#fff] flex flex-col basis-[300px] w-[300px] space-y-5 p-4" onOutsidePress={() => toggleShow(false)}>
                <StyledView className="flex flex-row items-center justify-center w-[200px] h-[40px] bg-[#2358ad] self-center">
                    <Text className="text-[#fff] font-bold">Confiramtion Du Retrait #ff4</Text>
                </StyledView>
                <StyledView className="flex flex-col flex-1 space-y-2">
                    <Text>vous êtes sur le point d'effectuez un Retrait de : </Text>
                    <Text className="font-semibold">Montant</Text>
                    <Text>Dans le compte suivant </Text>
                    <Text className="font-semibold">destinateur du retrait : </Text>
                </StyledView>
...
export default React.memo(NouveauRetrait)
