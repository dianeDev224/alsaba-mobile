...
import { RetraitItems } from '../../../app.data';
...
import NouveauRetrait from './nouveauRetrait';
import RetraitEffectuer from './retraitEffectuer';
import RetraitEnattentes from './retraitEnAttentes';
import RetraitRejeter from './retraitRejeter';
import RetraitValider from './retraitValider';

const StyledView = styled(View)

export default function MainRetrait(props) {
    ...
    return (
        <ComponentSafeArea>
            <StyledView className="w-full h-full">
                ...
                {(currentItem.id === 1 && currentItem.Name === "Nouveau Rétrait") && <NouveauRetrait />}
                {(currentItem.id === 2 && currentItem.Name === "Retraits Effectués") && <RetraitEffectuer />}
                {(currentItem.id === 3 && currentItem.Name === "Retraits En Attentes") && <RetraitEnattentes />}
                {(currentItem.id === 4 && currentItem.Name === "Retraits Validés") && <RetraitValider />}
                {(currentItem.id === 5 && currentItem.Name === "Retraits Rejetés") && <RetraitRejeter />}
            </StyledView>
        </ComponentSafeArea>
    )
}
