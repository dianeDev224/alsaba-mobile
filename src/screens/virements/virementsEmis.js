...
export default function VirementEmis({ itemName = "Transfert Annulés" }) {
    ...
    return (
        <StyledView className='flex-1 bg-[#e1d8e7]'>
            <StyledView className="flex flex-col item-center justify-center w-full">
                <Text className={`w-full font-bold text-[15px] italic text-[#5a2983] text-center my-2`}>Virements Emis</Text>
...
function actionButton(cellData, index, handleClick) {
    ...
    return (
        ...
        <Pressable className="flex-1 w-full flex-row items-center justify-center" onPress={handleClick}>
    ...
    return (
        <Modal isVisible={show} className={`flex flex-col b-[#ffa] self-center flex-1`}>
            <OutsidePressHandler className="bg-[#fff] flex flex-col basis-[250px] w-[300px] space-y-5 p-4" onOutsidePress={() => toggleShow(false)}>
                <StyledView className="flex flex-row items-center justify-center w-[250px] h-[40px] bg-[#5a2983] self-center">
                ...
                <StyledView className="flex flex-row justify-around">
                    <Pressable className="bg-[#e2c077] w-[100px] h-[30px] items-center justify-center" onPress={() => toggleShow(false)}>
