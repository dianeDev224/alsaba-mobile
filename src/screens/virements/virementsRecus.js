...
export default function VirementRecus() {
    ...
    return (
        <StyledView className='flex-1 bg-[#f8f8d9]'>
            <StyledView className="flex flex-col item-center justify-center w-full">
                <Text className={`w-full font-bold text-[15px] italic text-[#706f1e] text-center my-2`}>Virements Reçus</Text>
    ...
    return (
        <Modal isVisible={show} className={`flex flex-col b-[#ffa] self-center flex-1`}>
            <OutsidePressHandler className="bg-[#fff] flex flex-col basis-[250px] w-[300px] space-y-5 p-4" onOutsidePress={() => toggleShow(false)}>
                <StyledView className="flex flex-row items-center justify-center w-[250px] h-[40px] bg-[#706f1e] self-center">
                ...
                <StyledView className="flex flex-col flex-1 space-y-2">
                    ...
                    <Text className="font-semibold">Beenficiaire : </Text>
