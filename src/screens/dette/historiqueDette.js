...
export default function HistoriqueDette() {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={<StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#d1ebe8" }} className="flex  mt-5">
                <StyledView className="flex  flex-col item-center justify-center h-[100%] p-2 space-y-7">
                    <StyledView className='flex flex-row items-center justify-center'>
                        <Text className="font-bold text-[#626663]">
                            Histroique Des Dettes
                        </Text>
                    </StyledView>

                    <ScrollView>
                        <Table style={styles.head} borderStyle={{ borderWidth: 3, borderColor: '#fff' }}>
                            <TableWrapper className="flex flex-row bg-[#2c817a] h-[40px] rounded-lg flex-1">
                                {
                        ...
                        <StyledView className='flex flex-row w-full justify-center items-center h-[40px]'>
                            ...
                            <Text className={`font-bold text-[20px] bg-[#2c817a] text-[#fff]`}>{currentPage}</Text>
            ...
            appendStyle={{ parent: { left: '70%', width: '30%' }, child: { borderTopColor: '#2c817a' } }}
        />
    )
