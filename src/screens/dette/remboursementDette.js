...
export default function RemboursementDette() {

    const { width: SCREEN_WIDTH } = useWindowDimensions()

    return (
        <WithNavbarSwippe
            ScreenSwippe={<StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#caf5c9" }} className="flex  mt-5">
                <StyledView className="flex h-[100%] space-y-6">
                    <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Remboursement De Dette</Text>
