...
export default function HistoriquePret() {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#f0e0ee" }} className="flex  mt-5">
                    <StyledView className="flex  flex-col item-center justify-center h-[100%] p-2 space-y-7">
                        ...
                        <ScrollView>
                            <Table style={styles.head} borderStyle={{ borderWidth: 3, borderColor: '#fff' }}>
                                <TableWrapper className="flex flex-row bg-[#8f5387] h-[40px] rounded-lg flex-1">
                                    {
                            ...
                            <StyledView className='flex flex-row w-full justify-center items-center h-[40px]'>
                                ...
                                <Text className={`font-bold text-[20px] bg-[#8f5387] text-[#fff]`}>{currentPage}</Text>
            ...
            appendStyle={{ parent: { left: '70%', width: '30%' }, child: { borderTopColor: '#8f5387' } }}
        />
    )
