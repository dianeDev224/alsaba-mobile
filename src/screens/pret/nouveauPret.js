...
export default function NouveauPret() {
    ...
    return (
        ...
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#f0edc2" }} className="flex  mt-5">
                    <StyledView className="flex h-[100%] space-y-6">
                        <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Nouveau Prêt</Text>
            ...
            appendStyle={{ parent: { left: '0%', width: '30%' }, child: { borderTopColor: '#b5ae24' } }}
        />
    )
}
