...
export default function RemboursementPret() {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#d5f0d4" }} className="flex  mt-5">
                    <StyledView className="flex space-y-6">
                        <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Remboursement De Prêt</Text>
