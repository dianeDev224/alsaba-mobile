...
export default function NouvelleEpargne() {
    ...
    return (
        <WithNavbarSwippe
            ScreenSwippe={
                <StyledView style={{ width: SCREEN_WIDTH, backgroundColor: "#fcfadd" }} className="flex  mt-5">
                    <StyledView className="flex  space-y-6 h-[100%]">
                        <Text className="flex w-full text-center font-bold text-lg text-[#626663]">Nouvelle Epargne</Text>
                        <StyledView className="flex flex-col items-center space-y-[20px]">
